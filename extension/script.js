...
chrome.webRequest.onHeadersReceived.addListener(
	(details) => {
		if (chr) if (details.initiator !== "https://discordbotclient.jtmaveryk.repl.co") return;
		if (fir) if (!details.originUrl.includes("discordbotclient.jtmaveryk.repl.co")) return;
